...
If you discover a security vulnerability in RetailSaathi, please report it responsibly:
...
RetailSaathi is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- RetailSaathi aggregates publicly available OSINT data
...
- Vulnerabilities in the RetailSaathi codebase
...
Thank you for helping keep RetailSaathi and its users safe! 🔒
