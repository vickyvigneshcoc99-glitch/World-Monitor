# Contributing to RetailSaathi

Thank you for your interest in contributing to RetailSaathi! This project thrives on community contributions — whether it's code, data sources, documentation, or bug reports.
...
RetailSaathi is a real-time OSINT dashboard built with **Vanilla TypeScript** (no UI framework), **MapLibre GL + deck.gl** for map rendering, and a custom Proto-first RPC framework called **Sebuf** for all API communication.
...
- **Internationalization** — help make RetailSaathi available in more languages
...
Use the [Bug Report issue template](https://github.com/vickyvigneshcoc99-glitch/World-Monitor/issues/new/choose) when available.
...
Use the [Feature Request issue template](https://github.com/vickyvigneshcoc99-glitch/World-Monitor/issues/new/choose) when available.
...
Thank you for helping make RetailSaathi better! 🌍
